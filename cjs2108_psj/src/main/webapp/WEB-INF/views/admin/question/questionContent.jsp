...
<title>Q＆A내용</title>
	...
	<script>
  	...
  	function delCheck(){
  		...
  		if(ans) location.href="${ctp}/admin/questionDelete?idx=${vo.idx}&pag=${pag}&pageSize=${pageSize}";
  	}
  	// 댓글입력
  	function replyCheck(){
  		...
  		$.ajax({
  			type : "post",
  			url : "${ctp}/admin/questionReplyInsert",
  			data : query,
  			success:function(){
  				location.reload();
  			}
  	...
  	function replyCheck2(idx,pag,pageSize){
  		...
  		$.ajax({
  			type : "post",
  			url : "${ctp}/admin/questionReplyInsert2",
  			data : query,
  			success:function(){
  				location.reload();
  			}
  	...
  	function replyDelCheck(replyIdx){
  		...
  		$.ajax({
  			type : "post",
  			url : "${ctp}/admin/questionReplyDelete",
...
<body oncontextmenu='return false' ondragstart='return false'>
	...
	<div class="w3-main" style="margin-left:340px;margin-right:40px">
      ...
      <a href="${ctp}/admin/question" style="text-decoration: none;font-size:30pt;">Q＆A</a>
    </h2>
    <br>
      ...
      <tbody>
	      ...
	      <tr class="text-center">
	        <td class="con2" colspan="2">
	          <br>
	            <input class="btn btn-outline-warning" type="button" value="돌아가기" onclick="location.href='${ctp}/admin/question?pag=${pag}&pageSize=${pageSize}';"/>
	      			<c:if test="${sMid == vo.mid}">
	      				<input class="btn btn-outline-warning" type="button" value="수정" onclick="location.href='${ctp}/admin/questionUpdate?idx=${vo.idx}&pag=${pag}&pageSize=${pageSize}';"/>
		     			</c:if>
