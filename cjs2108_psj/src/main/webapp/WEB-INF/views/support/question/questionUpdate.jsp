...
<title>Q＆A 수정</title>
  ...
  <script src="${ctp}/js/questionUpdate.js"></script>
</head>
<body  oncontextmenu='return false' ondragstart='return false'>
	...
	<div class="w3-bar w3-padding-16 w3-large">
		<a href="${ctp}/support/questionContent?idx=${vo.idx}&pag=${pag}&pageSize=${pageSize}" class="btn w3-bar-item w3-margin-left"><i class="fa fa-arrow-left w3-xlarge"></i></a>
				...
				<form name="myform" method="post">
					...
					<table class="table">
						...
						<tr>
			              ...
			              <option value="상품문의" ${vo.what=='상품문의' ? 'selected' : ''}>상품문의</option>
			              <option value="반품문의" ${vo.what=='반품문의' ? 'selected' : ''}>반품문의</option>
			              <option value="배송문의" ${vo.what=='배송문의' ? 'selected' : ''}>배송문의</option>
			              <option value="불량/오발송문의" ${vo.what=='불량/오발송문의' ? 'selected' : ''}>불량/오발송문의</option>
						...
						<tr>
							<td colspan="2" style="text-align:center">
								...
								<input type="button" value="돌아가기" onclick="location.href='${ctp}/support/questionContent?idx=${vo.idx}&pag=${pag}&pageSize=${pageSize}';" class="btn btn-outline-warning"/>
							</td>
						</tr>
					</table>
