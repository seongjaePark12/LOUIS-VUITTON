...
a.removeEventListener && a.removeEventListener(b, c)},n.Event = function (a, b) {
return this instanceof n.Event
    ...
    : new n.Event(a, b)},n.Event.prototype = {
constructor: n.Event,
...
pointerleave: "pointerout"}, function (a, b) {
n.event.special[a] = {
    delegateType: b,
    bindType: b,
    handle: function (a) {
...
"input" === c && X.test(a.type)
    ? b.checked = a.checked
    : "input" !== c && "textarea" !== c || (b.defaultValue = a.defaultValue)}function ua(a, b, c, d) {
b = f.apply([], b);
var e,
    g,
    h,
...
return b
    ...
    : void 0}),n.cssHooks.marginRight = Ga(l.reliableMarginRight, function (a, b) {
return b
    ? Da(a, {
...
Aa.test(a) || (n.cssHooks[a + b].set = Na)}),n.fn.extend({
css: function (a, b) {
...
return new Ra.prototype.init(a, b, c, d, e)}n.Tween = Ra,Ra.prototype = {
constructor: Ra,
...
if (d = _a.prefilters[f].call(j, a, k, j.opts)) 
    ...
    d;
return n.map(k, Ya, j),n.isFunction(j.opts.start) && j.opts.start
.call(a, j),
...
ajax: function (b, c) {
    ...
    if (q.promise(x).complete = r.add, x.success = x.done, x.error = x.fail, m.url =(( b || m.url || jb.href) + "").replace(mb, "").replace(rb, jb.protocol + "//"), m.type = c.method || c.type || m.method || m.type, m.dataTypes = n
            .trim(m.dataType || "*")
            .toLowerCase()
